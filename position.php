...
<p></p>
            ...
            <div class="sidebar-menu" >
                <ul>
                    ...
                    <li class="side-nav">
                        <a class="current" href="position.php">
                            <span class="las la-users" ></span>
                            <span>Position</span>
                        </a>
                    </li>
    ...
    <header>
            <div class="header-title-wrapper">
                ...
                <div class="header-title">
                    <h1>Position</h1>
                    <p>Display Employee Position list <span class="las la-chart-line">
            ...
            <div class="header-action" style="text-align:center;">
                <a href="department.php">Go to School Departments</a>
            </div>
        </header>
        <main>
            ...
            <form action="process.php" method="POST" class="forms" >
                ...
                <input type="text" name="positionName" class="form-control" 
                    ...
                    <button type="submit" class="btn btn-info" name="insertPosition" style="margin-top:10px;">Save</button>
                    <a href="position.php" id="cancel" name="cancel" class="btn btn-danger" style="margin-top:10px;">Cancel</a>
